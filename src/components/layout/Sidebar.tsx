import { LayoutDashboard, Activity, History, MapPin, Flame, Video, Shield, BrainCircuit, ScanFace, GitBranch, Zap, Briefcase } from 'lucide-react';
...
const navItems: { key: ModuleKey; label: string; icon: typeof LayoutDashboard; description: string }[] = [
  ...
  { key: 'executive', label: 'Executive Overview', icon: Briefcase, description: 'Stakeholder summary' },
  ...
  { key: 'escalation', label: 'Escalation Timeline', icon: GitBranch, description: 'Threat progression tracking' },
  { key: 'response', label: 'AI Response Center', icon: Zap, description: 'Recommended actions' },
